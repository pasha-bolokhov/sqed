...
/*
 * Diagram "B3", SQED, Massive unbroken SUSY,
 * Gauge sector.
 */
main()
{
  ...
  // bar 1
  xy                     bar1_1 = bar_1; bar1_1.rotate(-90 + BAR_ANGLE + DBAR);
  xy                     bar1_2 = bar_2; bar1_2.rotate(-90 + BAR_ANGLE + DBAR);
  line_plain             bb1(fd, bar1_1, bar1_2);

  // bar 2
  xy                     bar2_1 = bar_1; bar2_1.rotate(-BAR_ANGLE);
  xy                     bar2_2 = bar_2; bar2_2.rotate(-BAR_ANGLE);
  line_plain             bb2(fd, bar2_1, bar2_2);

  // bar 3
  xy                     bar3_1 = bars_1; bar3_1.rotate(180 - BAR_ANGLE);
  xy                     bar3_2 = bars_2; bar3_2.rotate(180 - BAR_ANGLE);
