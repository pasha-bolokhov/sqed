...
/*
 * Diagram "A2", SQED, Massive unbroken SUSY,
 * Gauge sector.
 */
main()
{
  ...
  // bar 1
  xy                     bar1_1 = bar_1; bar1_1.rotate(BARS_ANGLE);
  xy                     bar1_2 = bar_2; bar1_2.rotate(BARS_ANGLE);
  line_plain             bb1(fd, bar1_1, bar1_2);
  ...
  // bar 3
  xy                     bar3_1 = bars_1; bar3_1.rotate(180 - BARS_ANGLE);
  xy                     bar3_2 = bars_2; bar3_2.rotate(180 - BARS_ANGLE);
